...
by implementing the getItemViewType(int) method (developer.android.com/reference/android/
support/v7/widget/RecyclerView.Adapter.html#getItemViewType). In the
onCreateViewHolder(ViewGroup, int) method, you will also need to add logic that returns
